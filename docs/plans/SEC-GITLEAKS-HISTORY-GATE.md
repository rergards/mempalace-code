...
The existing native launcher regains the two missing assurance predicates: reviewed exact-fingerprint suppressions and a real-binary five-class detector/redaction smoke. Exact candidate `e63dbe24ea4c80e3eb6d52dfc3cba46f5e7c0066` passed the required local and hosted qualification in Tests run `33510014129`, and the backlog item is archived.
