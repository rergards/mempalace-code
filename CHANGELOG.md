...
Minor release for ingest source safety, ChromaDB runtime retirement, explicit
...
- Synchronized package, lockfile, README badge, Agent Plugin manifest, and generated quality scorecards on version 1.14.0.

### Fixed

- Watchers now catch Ctrl-C arriving immediately after `watch-ready`, exit without a traceback, and restore their signal handlers (`REL-WATCH-READY-SIGINT-RACE`).
